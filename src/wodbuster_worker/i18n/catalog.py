...
EN: dict[str, str] = {
    ...
    "statistics.month.nav": "Change month",
    "statistics.month.previous": "⬅️ Previous",
    "statistics.month.next": "➡️ Next",
    "statistics.month.jump_label": "Jump to",
...
ES: dict[str, str] = {
    ...
    "statistics.month.label": "{month} {year}",
    "statistics.month.nav": "Cambiar de mes",
    "statistics.month.previous": "⬅️ Anterior",
    "statistics.month.next": "➡️ Siguiente",
